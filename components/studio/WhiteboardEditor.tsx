...
export default function WhiteboardEditor({
  ...
  return (
    <>
      ...
      <details open={!content.liveMode}>
        <summary>Board content & appearance</summary>
        ...
        <p>
          Drag on the board to draw. Drawings animate after the text/code, in
          the order you add them. {content.strokes?.length ?? 0}/100 strokes.
        </p>
        ...
        />
        <p>
          Fill changes the shirt; stroke changes the ink. Leave at least 2
          seconds after writing for the presenter to step aside.
        </p>
      </details>
    </>
  );
